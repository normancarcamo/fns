...
function Is() {
  ...
  this.is = Object.create(Object.prototype, {
    ...
    date: {
      configurable: true,
      enumerable: true,
      value: (x, i) => getResult(date(x), i)
    }
  });

  Object.defineProperties(this.is.date, {
    only: {
      configurable: true,
      enumerable: true,
      value: (x, i) => getResult(date.only(x), i)
    },
    time: {
      configurable: true,
      enumerable: true,
      value: (x, i) => getResult(date.time(x), i)
    },
    iso: {
      configurable: true,
      enumerable: true,
      value: (x, i) => getResult(date.iso(x), i)
    },
    instance: {
      configurable: true,
      enumerable: true,
      value: (x, i) => getResult(date.instance(x), i)
    },
    valid: {
      configurable: true,
      enumerable: true,
      value: (x, i) => getResult(date.valid(x), i)
    }
  });
